package nju.joytrip.datepicker;
...
public class CustomDatePicker implements View.OnClickListener, PickerView.OnSelectListener {
    ...
    private void initView() {
        ...
        mPickerDialog.findViewById(R.id.date_cancel).setOnClickListener(this);
        mPickerDialog.findViewById(R.id.date_confirm).setOnClickListener(this);
        mTvHourUnit = mPickerDialog.findViewById(R.id.hour_unit);
        mTvMinuteUnit = mPickerDialog.findViewById(R.id.minute_unit);
